...
export { APP_I18N_TOKEN, AppI18NService, AppI18NServiceFake } from './src/services/i18n/i18n';
...
export { AppThemeConfig } from './src/theme.config';
export { AppThemeModule } from './src/theme.module';
